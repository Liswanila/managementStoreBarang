...
// Untuk memasukkan barang baru ke dalam stack
...
// Untuk menampilkan semua barang dalam stack
void tampilkan_barang()
{
    if (kosong() == 0)
    {
...
// Untuk mengurutkan barang berdasarkan nama
void sorting_nama()
{
    int i, j, tempjumlah;
    string tempnama;
...
// Untuk mengurutkan barang berdasarkan jumlah
void sorting_jumlah()
{
    int i, j, tempjumlah;
    string tempnama;
...
// Untuk mengurutkan barang berdasarkan harga
void sorting_harga()
{
    int i, j, tempjumlah;
    string tempnama;
...
// Untuk mencari barang berdasarkan jumlah
void search_jumlah()
{
    if (kosong() == 0)
    {
...
// Untuk mencari barang berdasarkan harga
void search_harga()
{
    if (kosong() == 0)
    {
...
// Untuk menghapus barang dari stack
void hapus()
{
    if (kosong() == 0)
    {
